...
**Standard** [ASI09 Mitigation 7](reference/owasp-top-10-agentic-applications-2026.txt#L1044 "^ASI09-PREVIEW") requires you to "display a risk badge with source provenance and expected side effects"; [ASI02 Mitigation 2](reference/owasp-top-10-agentic-applications-2026.txt#L384 "^ASI02-CONFIRM") requires you to "Display a pre-execution plan or dry-run diff before final approval"
