...
Each id is bound to the words on its recorded line of the standard. verify.py fails when those
words move. Run this only when the standard itself has been replaced, then read
`git diff provisions.md` before committing.
