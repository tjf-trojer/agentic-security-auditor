...
**`reference/` holds the standard.** It is OWASP's document, reproduced so that any finding can
be checked against the provision it cites. Nothing in `reference/` is written by this
repository's author.
